...
/* 
    ...
    and divide each element (number) by 2. 
    Print the result in console.
*/

// CODE HERE

// const numbersDivided = numbers.forEach(function(element){
//   console.log(element/2)
// })

// const numbersDivided = numbers.forEach((element) => console.log(element/2))
...
const numbersDividedLoop = numbers.map((element) => console.log(element/2))
...
const newCitiesWithI = cities.filter((element) => element.endsWith('i'))

console.log(newCitiesWithI)
...
/* 
    ...
    identify each element of the 'fruits' array above if it's an apple or orange by its color. 
